...
import { predictForFarmer } from "../../service/service"; // Make sure this API supports file uploads
...
function UploadImage() {
  ...
  const handleOnSubmit = async (e) => {
    ...
    try {
      ...
      const result=await predictForFarmer(formData); 
      navigate("/farmer/predicted_result",{state:{result:result}});
    } catch (error) {
