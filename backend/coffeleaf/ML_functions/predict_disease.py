...
from coffeleaf.models import DiseaseRecommendation
...
def predict_disease(image_path):
    ...
    try:
        ...
        if recommendation:
            return disease_name, recommendation.recommendations, confidence, recommendation.description, recommendation.link
        else:
            # Default return if no recommendation is found
            return disease_name, "No recommendations available.", confidence, "No description available.", "No link available."
